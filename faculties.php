...
<a href="addfaculty.php"><button type="button" class="btn btn-info">&nbsp;Add Faculty&nbsp;</button></a>
<hr>
<?php
...
if(isset($_GET['id'])){
$id = $_GET['id'];
$delsql = "DELETE FROM faculties WHERE faculty_id=$id";
...
$sql = "SELECT faculty_id, name, mobile, email FROM faculties";
//echo $sql;
...
?>
            <tr>
                ...
                <a href="faculty_edit.php?id=<?php echo $row["faculty_id"]?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;
                <a href="faculties.php?id=<?php echo $row["faculty_id"]?>"><i class="fa fa-trash-o fa-stack text-danger"></i></a>
          </td>
            </tr>
<?php
    }
